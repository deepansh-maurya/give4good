...
export default function ChangeCred({
  ...
  function handlechange(e) {
    ...
    name != "profilePicture" && name != "document"
      ? setUPdateCred({ ...updateCred, [name]: value })
      : name == "profilePicture"
      ? setUPdateCred({ ...updateCred, profilePicture: value })
      : setUPdateCred({ ...updateCred, document: value });
    console.log(updateCred);
  }
  async function handleUpdateProfileChange() {
